...
<section class="inward_menu_bottom">
    <div class="container">
        <form class="inward_menu_bottom_block" name="inbound_step2_form" id="inbound_step2_form" method="post"
            action="<?php echo base_url();?>inbound/step2" autocomplete="off">
                                    ...
                                    <div class="airport_name">
                                        <div class="airport_name_holder">
                                            ...
                                            <input id="searchMapDestination" class="mapControls" type="text"
                                                ...
                                                value="<?php echo $this->session->userdata('desAddress');?>"
                                                tabindex="1">
                                            ...
                                            <input id="desLattitude" type="hidden" name="desLattitude"
                                                value="<?php echo $this->session->userdata('desLattitude');?>">
                                            <input id="desLognitude" type="hidden" name="desLognitude"
                                                value="<?php echo $this->session->userdata('desLognitude');?>">
                                        </div>
                                        <div class="airport_name_images">
                ...
                <div class="inward_main_block_holder_one">
                    <div class="inward_third_block">
                        ...
                        <a class="inward_custom_button inward_custom_button_one_one"
                            href="<?php echo base_url();?>inbound"><span>BACK</span></a>
                        <input type="submit"
                            class="inward_custom_button inward_custom_button_three" name="submit" value="CONTINUE">
...
<!-- <script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBxmvEdVoP2j5N1P2zsPVueMfTuYfo4GDI&libraries=places&callback=initMap"
    async defer></script> -->
...
$(document).ready(function() {
    ...
    <?php if($this->session->userdata('desAddress')=='') { ?>
    setTimeout(function() {
    ...
    $(".cross1").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>inbound/via1_address_destroy",
            data: {
    ...
    $(".cross2").click(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>inbound/via2_address_destroy",
            data: {
    ...
    $(".cross3").click(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>inbound/via3_address_destroy",
            data: {
    ...
    // $('#inbound_step2_form').on('keyup change paste', 'input, select, textarea', function() {
    //     validateForm();
    // });

    // function validateForm() {
    //     console.log($('#inbound_step2_form').valid() + ' ' + $('#flight_info_block').css('display'));

    //     if ($('#inbound_step2_form').valid()) {
