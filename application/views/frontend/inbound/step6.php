...
<section class="inward_menu_bottom">
    <div class="container">
        ...
        <form class="inward_menu_bottom_block" method="post" name="inbound_step6_form" id="inbound_step6_form"
            method="post" action="<?php echo base_url();?>inbound/step6" autocomplete="off">
                ...
                <div class="inward_main_block_holder_one">
                    <div class="inward_third_block">
                        ...
                        <a class="inward_custom_button inward_custom_button_one_one"
                            href="<?php echo base_url();?>inbound/step7"><span>NO</span></a>
                        <input type="submit"
