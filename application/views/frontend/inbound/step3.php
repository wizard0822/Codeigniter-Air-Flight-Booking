...
<section class="inward_menu_bottom">
    <div class="container">
        <form class="inward_menu_bottom_block" name="inbound_step3_form" id="inbound_step3_form" method="post"
            action="<?php echo base_url();?>inbound/step3" autocomplete="off">
                ...
                <div class="inward_main_block_holder">
                            ...
                            {?>
                                    <div class="dublin_main_block_one">
                                        <div>
                                            ...
                                            <span
                                                class="d-block"><?php echo $this->session->userdata('terminal_orig');?>
                                            </span>
                                            <!-- <span class="dublin_block_destination_text">Departure : <?php echo $this->session->userdata('departuretime');?></span> -->
                                        </div>
                                        <div>
                                            ...
                                            <!-- <span class="dublin_block_destination_text">Arrival : <?php echo $this->session->userdata('arrivaltime');?></span> -->
                                        </div>
                    ...
                    <div class="inward_main_block_holder_one">
                        ...
                        <div class="inward_third_block">
                            <label class="error-custom" id="text-info-24"></label>
...
$(document).ready(function() {
    ...
    if ($("#id_vehicletype option:selected").val() == '') {
        ...
        $("#no_cabin_cases").html(str2);
         ...
         <?php if($this->session->userdata('no_passengers')!='' AND $this->session->userdata('no_large_cases')!='' AND $this->session->userdata('no_cabin_cases')!=''){?>
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>inbound/fetch_passenger", //this  should be replace by your server side method
            data: {
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>inbound/fetch_large_case", //this  should be replace by your server side method
            data: {
                id_vehicletype: id_vehicletype
            },
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>inbound/fetch_small_case", //this  should be replace by your server side method
            data: {
                id_vehicletype: id_vehicletype,
    ...
    //     console.log($('#inbound_step3_form').valid() + ' ' + $('#flight_info_block').css('display'));

    //     if ($('#inbound_step3_form').valid()) {
...
$(document).ready(function() {
    ...
    var str1 = "";
    var str2 = "";
    // var no_passengers ='<?php echo $this->session->userdata('no_passengers')?>';
    // var no_large_cases ='<?php echo $this->session->userdata('no_large_cases')?>';
    // var no_cabin_cases ='<?php echo $this->session->userdata('no_cabin_cases')?>';
    // alert(no_passengers);
    // if(no_passengers!=''){
    //     $('#no_passengers option[value='+no_passengers+']').prop('selected',true);
    // }
    // if(no_large_cases!=''){
    //     $('#no_large_cases option[value='+no_large_cases+']').prop('selected',true);
    // }
    // if(no_cabin_cases!=''){
    //     $('#no_cabin_cases option[value='+no_cabin_cases+']').prop('selected',true);
    // }
    if ($("#id_vehicletype option:selected").val() == '') {
        str += '<option value="">Please Select</option>';
        str1 += '<option value="">Please Select</option>';
    ...
    $('#id_vehicletype').on('change', function() {
        ...
        var id_vehicletype = parseInt($('#id_vehicletype').val());
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>inbound/fetch_notice_period", //this  should be replace by your server side method
                data: {
                    id_vehicletype: id_vehicletype,
                },
                    success: function(data) {
        ...
        //         $('#text-info-24').show();
        //        //  setTimeout(function(){
        //        //   window.location.href = "<?php echo base_url();?>inbound";
        //        // }, 3000);
    ...
    // $(".inward_custom_button_three").on("click", function(){
    //         if($('.inward_custom_button_three').attr('type') === 'button'){
    //             setTimeout(function(){
    //              window.location.href = "<?php echo base_url();?>inbound";
    //            }, 3000);
    //         }
