...
<section class="inward_menu_bottom">
    <div class="container">
        <form class="inward_menu_bottom_block" name="round_step9_form" id="round_step9_form" method="post"
            action="<?php echo base_url();?>return/step9" autocomplete="off">
                        ...
                        <div class="inward_menu_bottom_inner">
                            <div class="inward_two_block_holder">
                                <div class="british_airways">
                                    <h4><?php echo $this->session->userdata('in_airline_name');?></h4>
                                    <!-- <h4>Early</h4> -->
                            ...
                            {?>
                                                    ...
                                                    <div
                                                        ...
                                                        <select name="id_vehicletype"
                                                            ...
                                                            <option value="<?php echo $value['id'];?>"
                                                                <?php if($value['id']==$this->session->userdata('in_id_vehicletype')){echo "selected";}?>>
                                    ...
                                    <div class="dublin_main_block_two_holder1 mt-4">
                                        ...
                                        <textarea class="select_round" name="notes" id="exampleFormControlTextarea2"
                                            rows="2"
                                            placeholder="Please enter notes..."><?php echo $this->session->userdata('in_notes');?></textarea>
                                    </div>
                    ...
                    <div class="inward_main_block_holder_one">
                        <div class="inward_third_block">
                            ...
                            <a class="inward_custom_button inward_custom_button_one_one"
                                href="<?php echo base_url();?>return/step8"><span>BACK</span></a>
...
$(document).ready(function() {
    ...
    if ($("#id_vehicletype option:selected").val() == '') {
        ...
        <?php if($this->session->userdata('in_no_passengers')!='' AND $this->session->userdata('in_no_large_cases')!='' AND $this->session->userdata('in_no_cabin_cases')!=''){?>
            var id_vehicletype = $("#id_vehicletype option:selected").val();
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/fetch_passenger1", //this  should be replace by your server side method
            data: {
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/fetch_large_case1", //this  should be replace by your server side method
            data: {
                id_vehicletype: id_vehicletype
            },
            ...
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/fetch_small_case1", //this  should be replace by your server side method
            data: {
                id_vehicletype: id_vehicletype,
    ...
    //             $('#text-info-24').show();
    //            //  setTimeout(function(){
    //            //   window.location.href = "<?php echo base_url();?>return/step7";
    //            // }, 3000);
    ...
    $('#id_vehicletype').on('change', function() {
        ...
        var id_vehicletype = parseInt($('#id_vehicletype').val());
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>round/fetch_notice_period1", //this  should be replace by your server side method
                data: {
                    id_vehicletype: id_vehicletype,
                },
                    success: function(data) {
