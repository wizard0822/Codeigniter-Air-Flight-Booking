...
<section class="inward_menu_bottom">
    <div class="container">
        <form class="inward_menu_bottom_block" name="round_step2_form" id="round_step2_form" method="post"
            action="<?php echo base_url();?>return/step2" autocomplete="off">
                    ...
                    <div class="inward_menu_bottom_inner">
                        <div class="inward_two_block_holder">
                            <div class="british_airways">
                                <h4><?php echo $this->session->userdata('out_airline_name');?>
                            ...
                            <div class="dublin_main_block">
                                <?php if($this->session->userdata('out_originName')!='' || $this->session->userdata('out_destinationName')!='')
                            {?>
                                <div class="dublin_main_block_one">
                                    <div>
                                        <span><?php echo $this->session->userdata('out_originName');?> </span>
                                        <span class="d-block"><?php echo $this->session->userdata('out_terminal_orig');?> </span>
                                    ...
                                    <div>
                                        ...
                                        <span class="dublin_block_destination-text-one">
                                            <?php echo $this->session->userdata('out_destinationName');?></span>
                                        <span class="d-block">
                                            <?php echo $this->session->userdata('out_terminal_dest');?></span>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
                                    ...
                                    <div class="airport_name">
                                        <div class="airport_name_holder">
                                            ...
                                            <input id="searchMapPickup" class="mapControls" type="text"
                                                ...
                                                value="<?php echo $this->session->userdata('out_pickAddress');?>"
                                                tabindex="1">
                                            ...
                                            <input id="pickLattitude" type="hidden" name="pickLattitude"
                                                value="<?php echo $this->session->userdata('out_pickLattitude');?>">
                                            <input id="pickLognitude" type="hidden" name="pickLognitude"
                                                value="<?php echo $this->session->userdata('out_pickLognitude');?>">
                                        </div>
                                        ...
                                        <div class="airport_name_holder">
                                            ...
                                            <!-- <select name="airport_id"
                                                ...
                                                <option value="<?php echo $value['id'];?>"
                                                    <?php if($value['id']==$this->session->userdata('out_airport_id')){echo "selected";} else { ?><?php if($value['ICAO']==$this->session->userdata('out_airport_select')){echo "selected";}?><?php } ?>>
                                                    <?php echo $value['name'];?>
                                                </option>
                                                <?php } ?>
                                            </select> -->
                                    ...
                                    <div class="airport_name">
                                        <div class="airport_name_holder">
                                            ...
                                            <input id="searchMapVia" class="mapControls" type="text"
                                                placeholder="Enter Via Location" name="via" tabindex="2">
                                ...
                                <div id="bubble1" class="bubble">
                                    <div class="dublin_main_block_inner_one">
                                        ...
                                        <input type="text" name="viaAddress1" id="viaAddress1"
                                            ...
                                            value="<?php echo $this->session->userdata('out_viaAddress1');?>">
                                        <input id="viaAddress_1" type="hidden" name="viaAddress_1"
                                            value="<?php echo $this->session->userdata('out_viaAddress1');?>">
                                        <input id="viaLattitude1" type="hidden" name="viaLattitude1"
                                            value="<?php echo $this->session->userdata('out_viaLattitude1');?>">
                                        <input id="viaLognitude1" type="hidden" name="viaLognitude1"
                                            value="<?php echo $this->session->userdata('out_viaLognitude1');?>">
                                        <!-- </div> -->
                                ...
                                <div id="bubble2" class="bubble">
                                    <div class="dublin_main_block_inner_one">
                                        ...
                                        <input type="text" name="viaAddress2" id="viaAddress2"
                                            class="dublin_main_block_input" disabled
                                            value="<?php echo $this->session->userdata('out_viaAddress2');?>">
                                        <input id="viaAddress_2" type="hidden" name="viaAddress_2"
                                            value="<?php echo $this->session->userdata('out_viaAddress2');?>">
                                        <input id="viaLattitude2" type="hidden" name="viaLattitude2"
                                            value="<?php echo $this->session->userdata('out_viaLattitude2');?>">
                                        <input id="viaLognitude2" type="hidden" name="viaLognitude2"
                                            value="<?php echo $this->session->userdata('out_viaLognitude2');?>">
                                ...
                                <div id="bubble3" class="bubble">
                                    <div class="dublin_main_block_inner_one">
                                        ...
                                        <input type="text" name="viaAddress3" id="viaAddress3"
                                            class="dublin_main_block_input" disabled
                                            value="<?php echo $this->session->userdata('out_viaAddress3');?>">
                                        <input id="viaAddress_3" type="hidden" name="viaAddress_3"
                                            value="<?php echo $this->session->userdata('out_viaAddress3');?>">
                                        <input id="viaLattitude3" type="hidden" name="viaLattitude3"
                                            value="<?php echo $this->session->userdata('out_viaLattitude3');?>">
                                        <input id="viaLognitude3" type="hidden" name="viaLognitude3"
                                            value="<?php echo $this->session->userdata('out_viaLognitude3');?>">
                ...
                <div class="inward_main_block_holder_one">
                    <div class="inward_third_block">
                        ...
                        <a class="inward_custom_button inward_custom_button_one_one"
                            href="<?php echo base_url();?>return"><span>BACK</span></a>
...
function initMap() {
    ...
    autocomplete1.addListener('place_changed', function() {
        ...
        var latitude=place.geometry.location.lat();
        var longitude=place.geometry.location.lng();
        if ($('#viaAddress1').val() == '' || $('#viaAddress1').val() == 'undefined') {
            $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/fetch_zone", //this  should be replace by your server side method
            data: {
        ...
        } else if ($('#viaAddress2').val() == '' || $('#viaAddress2').val() == 'undefined') {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/fetch_zone", //this  should be replace by your server side method
            data: {
        ...
        } else if ($('#viaAddress3').val() == '' || $('#viaAddress3').val() == 'undefined') {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/fetch_zone", //this  should be replace by your server side method
            data: {
...
$(document).ready(function() {
    ...
    <?php if($this->session->userdata('out_pickAddress')=='' || $this->session->userdata('out_pickAddress')=='undefined') { ?>
    setTimeout(function() {
    ...
    <?php } ?>
    //$("#airport_id").select2();
    <?php if($this->session->userdata('out_viaAddress1')!='' && $this->session->userdata('out_viaAddress2')=='' && $this->session->userdata('out_viaAddress3')=='') {?>
    // alert("ok1");
    $('#bubble1').show();
    $('.via1').show();
    document.getElementById('viaAddress1').value = '<?php echo $this->session->userdata('out_viaAddress1')?>';
    <?php } else if($this->session->userdata('out_viaAddress1')=='' && $this->session->userdata('viaAddress2')!='' && $this->session->userdata('out_viaAddress3')!='') {?>
    // alert("ok1");
    $('#bubble2').show();
    $('#bubble3').show();
    $('.via2').show();
    $('.via3').show();
    document.getElementById('viaAddress2').value = '<?php echo $this->session->userdata('out_viaAddress2')?>';
    document.getElementById('viaAddress3').value = '<?php echo $this->session->userdata('out_viaAddress3')?>';
    <?php } else if($this->session->userdata('out_viaAddress1')!='' && $this->session->userdata('out_viaAddress2')!='' && $this->session->userdata('out_viaAddress3')==''){?>
    // alert("ok");
    $('#bubble1').show();
    $('#bubble2').show();
    $('.via1').show();
    ...
    document.getElementById('viaAddress1').value = '<?php echo $this->session->userdata('out_viaAddress1')?>';
    document.getElementById('viaAddress2').value = '<?php echo $this->session->userdata('out_viaAddress2')?>';
    <?php } else if($this->session->userdata('viaAddress1')!='' && $this->session->userdata('out_viaAddress2')=='' && $this->session->userdata('viaAddress3')!=''){?>
    // alert("ok");
    $('#bubble1').show();
    $('#bubble3').show();
    $('.via1').show();
    ...
    document.getElementById('viaAddress1').value = '<?php echo $this->session->userdata('out_viaAddress1')?>';
    document.getElementById('viaAddress3').value = '<?php echo $this->session->userdata('out_viaAddress3')?>';
    <?php } else if($this->session->userdata('out_viaAddress3')!='' && $this->session->userdata('out_viaAddress1')!='' && $this->session->userdata('out_viaAddress2')!=''){?>
    $('#bubble1').show();
    $('#bubble2').show();
    $('#bubble3').show();
    $('.via1').show();
    ...
    $(".cross1").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/via1_address_destroy",
            data: {
    ...
    $(".cross2").click(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/via2_address_destroy",
            data: {
    ...
    $(".cross3").click(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>round/via3_address_destroy",
            data: {
