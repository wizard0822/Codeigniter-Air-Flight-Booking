...
<section class="inward_menu_bottom">
    <div class="container">
        ...
        <form class="inward_menu_bottom_block" method="post" name="outbound_step6_form" id="outbound_step6_form"
            method="post" action="<?php echo base_url();?>outbound/step6" autocomplete="off">
                    ...
                    <div class="inward_menu_bottom_inner twelve_main_holder">
                        <div class="thirteen">
                            ...
                            <div class="thirteen_two">
                                <?php if($this->session->userdata('tips')!=5){ ?>
                                ...
                                <?php } ?>
                                <?php if($this->session->userdata('tips')!=10){ ?>
                                ...
                                <?php } ?>
                                <?php if($this->session->userdata('tips')==15){ ?>
                                <div style="background-color: #1097d6; color: #fff"
                                ...
                                <?php } ?>
                                <?php if($this->session->userdata('tips')==20){ ?>
                                <div style="background-color: #1097d6; color: #fff"
                                ...
                                <?php } ?>
                                <?php if($this->session->userdata('tips')==20 || $this->session->userdata('tips')==15 || $this->session->userdata('tips')==10 || $this->session->userdata('tips')==5){ ?>
                            ...
                            <div class="input_with_icon_holder mt-4 w-50" style="display:none;" id="tip_value">
                                <div class="input_part position-relative">
                                    ...
                                    <input id="tip_id" name="tips" placeholder="Enter Amount"
                                        ...
                                        value="<?php echo $this->session->userdata('tips');?>" class="form-control">
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="inward_main_block_holder_one">
                    <div class="inward_third_block">
                        ...
                        <a class="inward_custom_button inward_custom_button_one_one"
                            href="<?php echo base_url();?>outbound/step7"><span>NO</span></a>
                        <input type="submit"
...
$(function() {
    ...
    <?php } ?>
    <?php if($this->session->userdata('tips')=='5' || $this->session->userdata('tips')=='10' || $this->session->userdata('tips')=='15' || $this->session->userdata('tips')=='20' || $this->session->userdata('tips')==''){?>
    $('#tip_value').css('display', 'none');
    <?php } else {?>
