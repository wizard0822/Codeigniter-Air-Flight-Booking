...
.flag-container {
  ...
  <section class="inward_menu_bottom">
      <div class="container">
          <form class="inward_menu_bottom_block" name="outbound_step4_form" id="outbound_step4_form" method="post"
              action="<?php echo base_url();?>outbound/step4" autocomplete="off">
              <div class="inward_main_block_holder step_four_inward_main_block_holder">
                  ...
                  <div class="inward_main_block_holder_one">
                      <div class="inward_menu_bottom_inner">
                          <!-- <h5 class="text-center font_18 primary_text_color font-weight-bold mt-2 mb-4">OUTBOUND
                              BOOKING DETAILS
                          </h5> -->
                  ...
                  <div class="inward_main_block_holder_one">
                      <div class="inward_third_block">
                          <a class="inward_custom_button inward_custom_button_one_one"
                              href="<?php echo base_url();?>outbound/step3"><span>BACK</span></a>
                          <input type="submit"
...
$(document).ready(function() {
    ...
    $('#save').on('click', function() {
        ...
        if (cName == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>outbound/save_customer_details",
                data: {
                    cName: cName,
                    cEmail: cEmail,
                    cPhone: cPhone,
