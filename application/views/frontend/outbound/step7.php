...
<section class="inward_menu_bottom">
    <div class="container">
        ...
        <?php } ?>
        <form class="inward_menu_bottom_block" method="post" name="outbound_step7_form" id="outbound_step7_form"
            method="post" action="<?php echo base_url();?>outbound/step7" autocomplete="off">
...
$(document).ready(function($) {
    ...
    $('#outbound_step7_form').on('submit', function() {
        if ($('#outbound_step7_form').valid()) {
    ...
    //     console.log($('#outbound_step7_form').valid() + ' ' + $('#flight_info_block').css('display'));
    //     if ($('#outbound_step7_form').valid()) {
