...
<section class="signin_form">
    <div class="signin_form_main_block">
        <div class="signin_form_main_block_inner">
            ...
            <?php } ?>
            <form autocomplete="off" action="<?php echo $base_url;?>verify-register-account/<?php echo $id;?>"
                name="account_verify_form" id="account_verify_form" method="post" enctype="multipart/form-data">
                <div class="tel_holder mb-4">
                    <div class="position-relative">
                        <input type="text" name="verification_code" id="verification_code"
                            placeholder="Enter Verification Code" value="<?php echo $verification_code;?>">
                    </div>
                    <div class="resend_verify_code mt-3">
                        <a href="<?php echo $base_url;?>signup/resend_verification_code/<?php echo $id;?>"
                            class="signin_custom_button">Resend verification Code</a>
                    </div>
                </div>
