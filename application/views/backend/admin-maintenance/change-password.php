        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="row">
                <div class="col-md-9"> <h3 class="box-title">Admin Change Password</h3></div>
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form class="form-horizontal" action="<?php echo $base_url; ?>admin/admin-maintenance/change-password/<?php echo $id;?>" method="post" id="change_password_add" name="change_password_add" enctype="multipart/form-data" >
                <div class="box-body">
