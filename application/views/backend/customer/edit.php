...
<body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 pull-right"><a href="<?php echo $base_url;?>admin/customer"
                                            class="btn pull-right btn-primary">Back</a></div>
                                </div>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <form class="form-horizontal" autocomplete="off"
                                    action="<?php echo $base_url; ?>admin/customer/edit/<?php echo base64_encode($details[0]['id']);?>"
                                    method="post" id="customer_edit" name="customer_edit" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="type" class="control-label col-md-3">First name</label>
                                            <div class="col-md-9">
                                                <input type="text" name="fname" id="fname" placeholder="First Name"
                                                    value="<?php echo $details[0]['firstname'];?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="lname" id="lname" placeholder="Last Name"
                                                    value="<?php echo $details[0]['lastname'];?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" name="email" id="email" placeholder="Email Address"
                                                    value="<?php echo $details[0]['email_address'];?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <div style="display:flex; align-items:center;">
                                                    <input style="width: 50px; text-align:center; margin-right:10px;"
                                                        type="text" class="form-control" name="country_code"
                                                        id="country_code" value="<?php echo $details[0]['country_code'];?>" oninput="this.value=this.value.replace(/[^0-9\+]/g,'');">
                                                    <input type="text" name="phone" class="form-control" id="phone"
                                                        placeholder="Telephone"
                                                        value="<?php echo $details[0]['telephone'];?>" maxlength="11"
    ...
    <script src="https://unpkg.com/jquery-input-mask-phone-number@1.0.4/dist/jquery-input-mask-phone-number.js">
    </script>
