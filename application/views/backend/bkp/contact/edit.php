		      ...
		      <div class="row">
		        <div class="col-xs-12">
		          <div class="box">
		            ...
		            <!-- /.box-header -->
		            <div class="box-body">
		               <form class="form-horizontal" action="<?php echo $base_url; ?>admin/about/edit/<?php echo base64_encode($list[0]['id']);?>" method="post" id="slider_add" name="slider_add" enctype="multipart/form-data" >
			                <div class="box-body">

				                 <div class="form-group">
				                    <label for="type" class="control-label col-md-3"> Title </label>
				                    <div class="col-md-9">
				                    	<input type="text" name="title_name" id="title_name" class="form-control" value="<?php echo $list[0]['about_us_title'];?>" placeholder="Enter Slider Title Name">
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                    	<input type="text" name="optional_title_name" id="optional_slider_name" class="form-control" value="<?php echo $list[0]['alt_name'];?>" placeholder="Enter Slider Title Name">
				                    </div>
				                </div>
				             ...
				             <!-- add image -->
									...
									<div class="col-md-9">
											<div class="active_img display_img">
									             ...
									             <img id="image_disp" class="thumbnail " 
									                src="<?php echo $base_url;?>assets/upload/about_us/<?php echo $list[0]['image'];?>" alt="">
				                ...
				                <div class="form-group">
				                	...
				                	<div class="col-md-9">
					                	<textarea name="editor1"><?php echo $list[0]['description'];?></textarea>
						                <script>
