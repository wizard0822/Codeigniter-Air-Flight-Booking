        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Contact us Content</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <form class="form-horizontal" action="<?php echo $base_url; ?>admin/contact_us_content/edit/<?php echo base64_encode($list['id']);?>" method="post" id="content_add" name="content_add" enctype="multipart/form-data" >
                <div class="box-body">
                 <div class="form-group">
                    <label for="type" class="control-label col-md-3">Address</label>
                    <div class="col-md-9">
                    <input type="text" name="address" id="address" class="form-control" value="<?php echo $list['address'];?>" placeholder="Enter Address">
                    </div>
                </div>
                <div class="form-group">
                    <label for="type" class="control-label col-md-3">Phone</label>
                    <div class="col-md-9">
                    <input type="text" name="phone" id="phone" class="form-control" value="<?php echo $list['phone'];?>" placeholder="Enter Phone Number">
                    </div>
                </div>
                <div class="form-group">
                    <label for="type" class="control-label col-md-3">Email</label>
                    <div class="col-md-9">
                    <input type="text" name="email" id="email" class="form-control" value="<?php echo $list['email'];?>" placeholder="Enter Email">
                    </div>
                </div>
                <div class="form-group">
                    <label for="type" class="control-label col-md-3">Business Hours</label>
                    <div class="col-md-9">
                   <textarea name="business_hours" id="hours" class="form-control form-control-lg"><?php echo $list['business_hours'];?></textarea>
                    </div>
                </div>
