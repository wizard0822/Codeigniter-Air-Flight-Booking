  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Promo Code - Edit</li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="row">
                <div class="col-md-9"> <h3 class="box-title">Edit Promo Code</h3></div>
                <div class="col-md-3 pull-right" ><a href="<?php echo $base_url;?>admin/promocode" class="btn pull-right btn-primary">Back</a></div>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <form class="form-horizontal" autocomplete="off" action="<?php echo $base_url; ?>admin/promocode/edit/<?php echo base64_encode($promocode[0]['id']); ?>" method="post" id="promocode_edit" name="customer_add" enctype="multipart/form-data" >
                <div class="box-body">
                 <div class="form-group">
                    <label for="type" class="control-label col-md-3">Code</label>
                    <div class="col-md-9">
                     <input type="text" name="code" id="code" placeholder="Code"
                            value="<?php echo $promocode[0]['code'];?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="fixed_customer_amount" id="fixed_customer_amount" placeholder="Fixed Customer Amount"
                            value="<?php echo $promocode[0]['fixed_customer_amount'];?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="fixed_driver_amount" id="fixed_driver_amount" placeholder="Fixed Driver Amount"
                            value="<?php echo $promocode[0]['fixed_driver_amount'];?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="percent_customer_amount" id="percent_customer_amount" placeholder="Percent Customer Amount"
                            value="<?php echo $promocode[0]['percent_customer_amount'];?>" class="form-control">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" name="percent_driver_amount" id="percent_driver_amount" placeholder="Percent Driver Amount"
                              value="<?php echo $promocode[0]['percent_driver_amount'];?>" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" name="expiry_date" id="expiry_date" placeholder="Expiry Date"
                              value="<?php echo $promocode[0]['expiry_date'];?>" class="form-control">
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" name="expiry_count" id="expiry_count" placeholder="Expiry Count"
                              value="<?php echo $promocode[0]['expiry_count'];?>" class="form-control">
                    </div>
                  </div>
