        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <div class="row">
                <div class="col-md-9"> <h3 class="box-title">Add Price</h3></div>
            ...
            <!-- /.box-header -->
            <div class="box-body">
               <form class="form-horizontal" autocomplete="off" action="<?php echo $base_url; ?>admin/price-management/add" method="post" id="price_add" name="price_add" enctype="multipart/form-data" >
                <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_zone" id="id_zone" >
                     ...
                     <?php foreach($zone_list as $key => $value) { ?>
                                <option value="<?php echo $value['ID_Zone'];?>"><?php echo $value['Name'];?></option>
                       <?php } ?>         
                      </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                    <input type="text" name="customer_price" id="customer_price" class="form-control" placeholder="Enter Customer Price" value="<?php echo $customer_price;?>" oninput="this.value=this.value.replace(/[^0-9\.]/g,'');">
                    </div>
                </div>
                <div class="form-group">
                    <label for="type" class="control-label col-md-3">Driver Price</label>
                    <div class="col-md-9">
                    <input type="text" name="driver_price" id="driver_price" class="form-control" placeholder="Enter Driver Price" value="<?php echo $driver_price;?>" oninput="this.value=this.value.replace(/[^0-9\.]/g,'');">
                    </div>
                </div>
                  <div class="form-group">
